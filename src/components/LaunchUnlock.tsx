...
const MEMBERS = [
  { name: 'Member 1', role: 'Founder Access' },
  { name: 'Member 2', role: 'Co-Founder Access' },
  { name: 'Member 3', role: 'Core Team Access' },
];
            ...
            >
              ...
              <div style={{
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ fontSize: '12px', color: '#7A7A99', marginTop: '2px' }}>
                    {MEMBERS[i].role}
                  </div>
                </div>
